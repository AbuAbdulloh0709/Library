...
public class GoToHistoryForStudentCommand implements Command {
    ...
    public Router execute(HttpServletRequest request) {
        ...
        try {
            List<Order> issuedBooks = orderService.searchOrderHistoryForStudent(user_id, from_date, to_date, null);
