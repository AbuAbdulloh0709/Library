...
public class AcceptCommand implements Command {
    ...
    public Router execute(HttpServletRequest request) {
        ...
        try {
            orderDetailService.acceptRequestedBook(orderDetailMap);
            List<Order> issuedBooks = orderService.searchRequestedBooksByQuery(searchText, page);
            List<Order> nextIssuedBooks = orderService.searchRequestedBooksByQuery(searchText, page + 1);
