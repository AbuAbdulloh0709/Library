...
public class GoToStudentRequestBooksCommand implements Command {
    ...
    public Router execute(HttpServletRequest request) {
        ...
        try {
            List<Order> issuedBooks = orderService.requestedBooks(page);
            List<Order> nextIssuedBooks = orderService.requestedBooks(page + 1);
