...
public class PagePath {
    ...
    public static final String ERROR_403 = "/pages/error/error_403.jsp";
    ...
    public static final String ADMIN = "/pages/admin/book/add.jsp";
    public static final String DASHBOARD = "/pages/admin/dashboard.jsp";
    public static final String ADMINISTRATORS = "/pages/admin/administrators.jsp";
    ...
    public static final String ALL_BOOKS = "/pages/admin/book/all_books_in_library.jsp";
    ...
    public static final String HISTORY = "/pages/admin/order/history.jsp";
    public static final String EDIT_BOOK_INFO = "/pages/admin/book/edit_book_info.jsp";
    public static final String REPLACE_BOOK_IMAGE = "/pages/admin/book/replace_book_image.jsp";
