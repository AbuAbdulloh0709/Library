...
public class ChangeUserStatusCommand implements Command {
    ...
    public Router execute(HttpServletRequest request) {
        ...
        String new_status = request.getParameter(RequestParameter.NEW_STATUS);

        try {
            userService.changeUserStatus(id, UserStatus.valueOf(new_status.toUpperCase()));
            ...
            LOGGER.error("Error has occurred while redirecting to all students page after updating user status: " + e);
