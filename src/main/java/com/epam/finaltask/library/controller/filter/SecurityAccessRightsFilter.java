...
public class SecurityAccessRightsFilter implements Filter {
    ...
    public void init(FilterConfig filterConfig) {
        ...
        accessibleCommands.put(ADMIN, List.of(GO_TO_SIGN_UP, GO_TO_SIGN_IN, GO_TO_ADMIN, GO_TO_DASHBOARD,
                GO_TO_ADMINISTRATORS, GO_TO_LIBRARIANS, GO_TO_ALL_WAITING_STUDENTS, GO_TO_ALL_APPROVED_STUDENTS, GO_TO_ALL_STUDENTS,
                GO_TO_ALL_BOOKS, GO_TO_ADD_BOOK_GENRE, GO_TO_ADD_BOOKS, GO_TO_ISSUE_RETURN_BOOKS, SIGN_UP, SIGN_UP,
                ADD_ADMINISTRATOR, ADD_LIBRARIAN, CHANGE_USER_STATUS, GO_TO_ISSUED_BOOKS,
                SEARCH_STUDENTS, CHANGE_USER_STATUS, ADD_BOOK_GENRE, EDIT_BOOK_GENRE, ADD_BOOK, DEFAULT));
        accessibleCommands.put(LIBRARIAN, List.of(GO_TO_SIGN_UP, GO_TO_SIGN_IN, GO_TO_ADMIN, GO_TO_DASHBOARD,
                GO_TO_ADMINISTRATORS, GO_TO_LIBRARIANS, GO_TO_ALL_WAITING_STUDENTS, GO_TO_ALL_APPROVED_STUDENTS, GO_TO_ALL_STUDENTS,
                GO_TO_ALL_BOOKS, GO_TO_ADD_BOOK_GENRE, GO_TO_ADD_BOOKS, GO_TO_ISSUE_RETURN_BOOKS, SIGN_UP, SIGN_UP,
                ADD_ADMINISTRATOR, ADD_LIBRARIAN, CHANGE_USER_STATUS, GO_TO_ISSUED_BOOKS,
                SEARCH_STUDENTS, CHANGE_USER_STATUS, ADD_BOOK_GENRE, EDIT_BOOK_GENRE, ADD_BOOK, DEFAULT));
        accessibleCommands.put(STUDENT, List.of(GO_TO_SIGN_UP, GO_TO_SIGN_IN, GO_TO_DASHBOARD,
                SIGN_UP, SIGN_UP, DEFAULT));
        accessibleCommands.put(GUEST, List.of(GO_TO_SIGN_UP, GO_TO_SIGN_IN, SIGN_UP, SIGN_IN,
                SIGN_UP, DEFAULT));
    }
