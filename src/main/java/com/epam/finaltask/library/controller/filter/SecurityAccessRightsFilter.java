...
public class SecurityAccessRightsFilter implements Filter {
    ...
    public void init(FilterConfig filterConfig) {
        ...
        accessibleCommands.put(ADMIN, List.of(GO_TO_SIGN_UP, GO_TO_SIGN_IN, GO_TO_DASHBOARD, GO_TO_SHOW_BOOKS_FOR_GUEST,
                GO_TO_ADMINISTRATORS, GO_TO_LIBRARIANS, GO_TO_ALL_STUDENTS, GO_TO_EDIT_BOOK_INFO,
                GO_TO_ALL_BOOKS, GO_TO_ADD_BOOK_GENRE, GO_TO_ADD_BOOKS, GO_TO_REQUESTS, SIGN_UP, SIGN_UP, SEARCH_ISSUED_BOOKS, EDIT_BOOK_INFO,
                ADD_ADMINISTRATOR, ADD_LIBRARIAN, CHANGE_USER_STATUS, GO_TO_ISSUED_BOOKS, GO_TO_BOOKS_TO_ISSUE, GO_TO_ISSUE_BOOK_BY_STUDENT, GO_TO_HISTORY,
                GO_TO_ISSUE_BOOK, ISSUE_BOOK, RETURN_ISSUED_BOOK, REJECT_REQUEST, ACCEPT_REQUEST, VIEW_ISSUED_BOOK_DETAILS, SEARCH_REQUESTS, SEARCH_HISTORY,
                SEARCH_BOOKS, REPLACE_BOOK_IMAGE, GO_TO_REPLACE_BOOK_IMAGE, SIGN_OUT, GO_TO_PROFILE, UPDATE_USER_DETAILS,
                SEARCH_STUDENTS, CHANGE_USER_STATUS, ADD_BOOK_GENRE, EDIT_BOOK_GENRE, ADD_BOOK, ISSUE_BOOK_BY_STUDENT, DEFAULT));
        accessibleCommands.put(LIBRARIAN, List.of(GO_TO_SIGN_UP, GO_TO_SIGN_IN, GO_TO_DASHBOARD, GO_TO_SHOW_BOOKS_FOR_GUEST,
                GO_TO_ALL_STUDENTS, GO_TO_EDIT_BOOK_INFO, GO_TO_ALL_BOOKS, GO_TO_ADD_BOOK_GENRE, GO_TO_ADD_BOOKS, GO_TO_REQUESTS, SIGN_UP, SIGN_UP, SEARCH_ISSUED_BOOKS, SEARCH_HISTORY,
                SEARCH_BOOKS, REPLACE_BOOK_IMAGE, GO_TO_REPLACE_BOOK_IMAGE, SIGN_OUT, GO_TO_PROFILE, UPDATE_USER_DETAILS,
                CHANGE_USER_STATUS, GO_TO_ISSUED_BOOKS, GO_TO_BOOKS_TO_ISSUE, SEARCH_REQUESTS, EDIT_BOOK_INFO,
                GO_TO_ISSUE_BOOK, ISSUE_BOOK, RETURN_ISSUED_BOOK, REJECT_REQUEST, ACCEPT_REQUEST, VIEW_ISSUED_BOOK_DETAILS, GO_TO_HISTORY,
                SEARCH_STUDENTS, CHANGE_USER_STATUS, ADD_BOOK_GENRE, EDIT_BOOK_GENRE, ADD_BOOK, ISSUE_BOOK_BY_STUDENT, DEFAULT));
        accessibleCommands.put(STUDENT, List.of(GO_TO_SIGN_UP, GO_TO_SIGN_IN, GO_TO_SHOW_BOOKS_FOR_GUEST, GO_TO_DASHBOARD, GO_TO_BOOKS_TO_ISSUE,
                SIGN_UP, SIGN_UP, ISSUE_BOOK_BY_STUDENT, VIEW_ISSUED_BOOK_DETAILS, GO_TO_ISSUE_BOOK_BY_STUDENT, SIGN_OUT, GO_TO_PROFILE, UPDATE_USER_DETAILS, GO_TO_HISTORY_FOR_STUDENT, SEARCH_HISTORY_FOR_STUDENT, DEFAULT));
