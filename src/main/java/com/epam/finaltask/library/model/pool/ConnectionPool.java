package com.epam.finaltask.library.model.pool;
...
public class ConnectionPool {
    ...
    private static BlockingDeque<Connection> freeConnections;
    private static BlockingDeque<Connection> takenConnections;
