            ...
            <div>
                <div>
                    <button class="add-button" type="button" data-bs-toggle="modal"
                            data-bs-target="#addUserModal" data-bs-whatever="@mdo"><fmt:message key="admin.dashboard.add_new_librarian"/></button>
                    ...
                    <table>
                        ...
                        <c:forEach var="librarian" items="${requestScope.librarians}">
                            <tr>
                                ...
                                <td>${librarian.passportNumber}</td>
                                <td>${librarian.birthDate}</td>
